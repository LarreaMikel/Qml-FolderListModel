...
UBUNTU_TRANSLATION_DOMAIN="qml-folderlistmodel.larreamikel"
...
aptest.commands = bash $$PWD/Qml-FolderListModel/tests/autopilot/run
aptest.depends  = sub-Qml-FolderListModel

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/Qml-FolderListModel/tests/unit 
unittest.depends  = sub-Qml-FolderListModel
